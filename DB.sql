...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 23 2018 г., 17:25
...
INSERT INTO `shop_catalog` (`id`, `name`, `id_catalog`) VALUES
(1, 'Первый каталог', 0),
(3, 'Подкаталог 1', 1),
(4, 'Второй ред', 0),
(5, 'Третий', 0),
...
INSERT INTO `shop_product` (`id`, `name`, `img`, `description`, `vendor_code`, `price`, `time`, `id_catalog`) VALUES
